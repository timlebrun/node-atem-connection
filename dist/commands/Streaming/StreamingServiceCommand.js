...
class StreamingServiceUpdateCommand extends CommandBase_1.DeserializedCommand {
	...
	static deserialize(rawCommand) {
		const props = {
			serviceName: atemUtil_1.bufToNullTerminatedString(rawCommand, 0, 64),
			url: atemUtil_1.bufToNullTerminatedString(rawCommand, 64, 512),
			key: atemUtil_1.bufToNullTerminatedString(rawCommand, 576, 512),
