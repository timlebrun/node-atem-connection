...
class MixEffectKeyPropertiesGetCommand extends CommandBase_1.DeserializedCommand {
	...
	applyToState(state) {
		...
		mixEffect.upstreamKeyers[this.properties.upstreamKeyerId] = Object.assign(
			Object.assign({}, state_1.AtemStateUtil.getUpstreamKeyer(mixEffect, this.properties.upstreamKeyerId)),
			this.properties
		)
